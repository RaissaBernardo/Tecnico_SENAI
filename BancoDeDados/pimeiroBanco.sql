...
select nome from Funcionario F where exists (select * from FuncionarioProjeto FP where F.numero = FP.numeroFunc);
select nome from Funcionario F where not exists (select * from FuncionarioProjeto FP where F.numero = FP.numeroFunc);
select nome from Funcionario F, FuncionarioProjeto FP where F.numero = FP.numeroFunc AND horas in ('08:25:00','43:48:54');
